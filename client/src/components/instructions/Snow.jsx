      ...
      >
        <div className="p-8 flex flex-col">
          <ul className="list-disc space-y-2">
            ...
            <li className="text-sm text-gray-300 font-sans font-bold">
              Ensure your home is adequately heated. Use a space heater if necessary, but follow safety guidelines.
            </li>
            <li className="text-sm text-gray-300 font-sans font-bold">
            ...
            <li className="text-sm text-gray-300 font-sans font-bold">
              Be aware of the signs of hypothermia, such as shivering, slurred speech, slow breathing, and confusion. If you suspect hypothermia, seek medical attention immediately.
            </li>
          </ul>
...
export function Snow() {
    return (
      ...
      >
        <div className="p-8 flex flex-col">
          <ul className="list-disc space-y-2">
            <li className="text-sm  font-sans font-bold">
              Wear multiple layers of loose-fitting, lightweight clothing. Layering helps trap warm air and provides better insulation.
            </li>
            <li className="text-sm  font-sans font-bold">
            ...
            <li className="text-sm font-sans font-bold">
              Drive slowly and keep a safe distance from other vehicles. Watch out for ice and snow on the roads.
            </li>
            <li className="text-sm  font-sans font-bold">
              Keep your home and office heated to a comfortable temperature. Use space heaters safely if needed.
            </li>
            <li className="text-sm  font-sans font-bold">
              Ensure you have an emergency kit in your vehicle, including blankets, food, water, and a shovel.
            </li>
          </ul>
